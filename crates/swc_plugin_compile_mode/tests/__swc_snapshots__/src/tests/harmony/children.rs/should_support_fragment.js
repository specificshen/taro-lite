...
export default struct TARO_TEMPLATES_f0t0 {
  ...
  build() {
    Column() {
      ...
      Column() {
        createText(this.node0.childNodes[2].childNodes[0] as TaroTextElement)
      }
      ...
      Column() {
        ...
        Column() {
          createText(this.node0.childNodes[3].childNodes[1].childNodes[0] as TaroTextElement)
        }
      ...
      Column() {
        createText(this.node5.childNodes[0] as TaroTextElement)
      }
      ...
      Column() {
        createText(this.node0.childNodes[7].childNodes[0] as TaroTextElement)
      }
      ...
      Column() {
        createText(this.node0.childNodes[8].childNodes[0] as TaroTextElement)
      }
