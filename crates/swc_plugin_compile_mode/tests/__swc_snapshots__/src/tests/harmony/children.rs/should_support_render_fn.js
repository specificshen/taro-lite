...
export default struct TARO_TEMPLATES_f0t0 {
  ...
  build() {
    Column() {
      Column() {
        createChildItem(this.node1.childNodes[0] as TaroElement, createLazyChildren)
      }
      ...
      Column() {
        createChildItem(this.node2.childNodes[0] as TaroElement, createLazyChildren)
        createText(this.node2.childNodes[1] as TaroTextElement)
      }
      ...
      Column() {
        createChildItem(this.node3.childNodes[0] as TaroElement, createLazyChildren)
      }
